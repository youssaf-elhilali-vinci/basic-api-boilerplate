...
- Si vous ouvrez un seul projet au sein de VS Code, c'est-à-dire que le folder ouvert de VS Code est
...
A chaque fois, il lance le linter, et si tout est OK, alors il lance **node**. En cas de souci, il
